...
<html>
    <head>
		...
		<g:render template="/autoComplete/suggestions" model="[supplyClass: Paket.newInstance().getClass().getSimpleName()]" />
    </head>
    <body>
        <div class="nav">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: paketInstance, field: 'entity', 'errors')}">
                                    <g:select name="entity.id" from="${de.webmpuls.dontforgetyourfoodsupplies.Entity.listOrderByName()}" optionKey="id" value="${paketInstance?.entity?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: paketInstance, field: 'foodCategory', 'errors')}">
                                    <g:select name="foodCategory.id" from="${de.webmpuls.dontforgetyourfoodsupplies.FoodCategory.listOrderByName()}" optionKey="id" value="${paketInstance?.foodCategory?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
