            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="paket.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="paket.name.label" default="Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="paket.amount.label" default="Amount" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="paket.entity.label" default="Entity" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="paket.foodCategory.label" default="Food Category" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="paket.eingefrorenAm.label" default="Eingefroren Am" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${paketInstance?.eingefrorenAm}" /></td>
